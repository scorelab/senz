...
class TopNavBar extends Component {
    ...
    render() {
        ...
        const sideList = (
            <div>
                <Typography variant="h4" style={styles.navbarTitle}>SenZ admin panel</Typography>
                <List>
        ...
        return (
            <AppBar position="fixed" style={styles.navbar}>
                ...
                <Toolbar>
                    ...
                    <Typography variant="h5" style={styles.navbarTitle}>SenZ admin panel</Typography>

                    <Button style={styles.navbarLinks} component={Link} to='/dashboard'>DASHBOARD</Button>


                    <IconButton color="inherit" style={styles.navbarLinks}
